...
────────────────────────────────────────────────────────────────────
  ...
  Next:
    ...
    5. Optional — the Jev decision layer for Claude Code now lives in
       the skills repo, not here:
         npx --yes github:pde201/skills/skills/intelligence/jev claude
         ~/.claude/skills/jev/install.sh
       The zsh claude wrapper here already resolves TYPESAFE_API_KEY for
       it; without a key the hooks stay dormant.
